...
![alt text](heuristicas/TailwindConf.png)

![alt text](heuristicas/TailwindAlex.png)

2. Interfaz limpia, centrada en el usuario y con retroalimentación visual. PASO

![alt text](heuristicas/TailwindPaso2.png)

![alt text](heuristicas/TailwindPaso2Alex.png)

3. Codigo con ejemplos aplicados. PASO 3 y 4

![alt text](heuristicas/TailwindPaso3.png)

![alt text](heuristicas/TailwindPaso3Alex.png)

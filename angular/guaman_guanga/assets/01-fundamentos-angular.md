...
![alt text](instalacion/crear_Proyecto.png)
...
pnpm install
```
![alt text](instalacion/instalar_Dependencias.png)
...
```
![alt text](instalacion/iniciar_ServidorAngular.png)
...
ng build
```
![alt text](instalacion/compilacion.png)

...
https://kennypallchizaca-coder.github.io/03-ui-componentes/

2. Captura de pagina con estilos aplicados 

![alt text](estilos/PaginaEstilo.png)

![alt text](estilos/PaginaEstilo2.png)

3. Captura de estilos-page.html

![alt text](estilos/pagehtml.png)

![alt text](estilos/pagehtml2.png)

![alt text](estilos/pagehtml3.png)

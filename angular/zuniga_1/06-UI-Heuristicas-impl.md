...
@Component({
  ...
  template: `
    <div
      class="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-800 text-white p-8 rounded-2xl shadow-2xl mb-8"
    >
      ...
      <!-- Concepto -->
      <div
        class="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20"
      >
      ...
      <div class="flex flex-wrap gap-2 mt-6">
        <span
          class="px-3 py-1 bg-green-500 bg-opacity-80 rounded-full text-xs font-semibold"
        >
          Nielsen Heuristic
        </span>
        <span
          class="px-3 py-1 bg-blue-500 bg-opacity-80 rounded-full text-xs font-semibold"
        >
          UX Best Practice
        </span>
        <span
          class="px-3 py-1 bg-purple-500 bg-opacity-80 rounded-full text-xs font-semibold"
        >
          Angular + Tailwind
        </span>
      </div>
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="text-center mb-12">
      ...
      <p class="text-xl text-gray-600 max-w-3xl mx-auto">
        Implementación práctica de las 10 heurísticas fundamentales para crear
        ...
        <table class="w-full">
          <thead class="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th
                class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-32"
              >
                Icono
              </th>
              <th
              ...
              <th
                class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-40"
              >
                Acciones
              </th>
            </tr>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50 transition-colors duration-200 group">
              <td class="px-6 py-4 whitespace-nowrap">
                <div
                  class="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full text-white font-bold text-sm"
                >
                  {{ heuristica.id }}
                </div>
              </td>
    ...
    <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
      <div
        class="bg-gradient-to-br from-green-50 to-emerald-100 p-6 rounded-xl border border-green-200"
      >
        <div class="flex items-center mb-4">
          ...
          <h3 class="ml-3 text-lg font-semibold text-green-800">
            Ejemplos Prácticos
          </h3>
        </div>
        <p class="text-green-700 text-sm">
          Cada heurística incluye ejemplos reales de implementación incorrecta y
          su versión mejorada.
        </p>
      </div>

      <div
        class="bg-gradient-to-br from-blue-50 to-cyan-100 p-6 rounded-xl border border-blue-200"
      >
        <div class="flex items-center mb-4">
          <div
          ...
          <h3 class="ml-3 text-lg font-semibold text-blue-800">
            Angular + Tailwind
          </h3>
        </div>
        <p class="text-blue-700 text-sm">
          Implementaciones modernas usando Angular signals, componentes
          standalone y TailwindCSS.
        </p>
      </div>

      <div
        class="bg-gradient-to-br from-purple-50 to-pink-100 p-6 rounded-xl border border-purple-200"
      >
        <div class="flex items-center mb-4">
          <div
          ...
          <h3 class="ml-3 text-lg font-semibold text-purple-800">
            UX Mejorada
          </h3>
        </div>
        <p class="text-purple-700 text-sm">
          Aprende cómo aplicar principios de usabilidad que mejoran
  ...
  heuristicas = signal<Heuristica[]>([
    {
      ...
      icono: "👁️",
      descripcion:
        "El sistema debe mantener informados a los usuarios sobre lo que está ocurriendo.",
      ruta: "/heuristica/1",
    },
    {
      id: 2,
      ...
      icono: "🌍",
      descripcion:
        "El sistema debe hablar el idioma del usuario con conceptos familiares.",
      ruta: "/heuristica/2",
    },
    {
      id: 3,
      ...
      icono: "🎮",
      descripcion:
        "Los usuarios necesitan controlar el sistema y tener salidas de emergencia.",
      ruta: "/heuristica/3",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      icono: "🚫",
      descripcion:
        "Mejor prevenir errores que mostrar buenos mensajes de error.",
      ruta: "/heuristica/5",
    },
    {
      id: 6,
      ...
      icono: "💭",
      descripcion:
        "Hacer visibles objetos y acciones en lugar de requerir memoria.",
      ruta: "/heuristica/6",
    },
    {
      id: 7,
      ...
      icono: "⚡",
      descripción:
        "Acelerar la interacción para usuarios expertos sin afectar novatos.",
      ruta: "/heuristica/7",
    },
    {
      id: 8,
      ...
      icono: "🎨",
      descripcion:
        "No incluir información irrelevante que compita con contenido importante.",
      ruta: "/heuristica/8",
    },
    {
      id: 9,
      ...
      icono: "🆘",
      descripcion:
        "Mensajes de error en lenguaje sencillo con soluciones constructivas.",
      ruta: "/heuristica/9",
    },
    {
      id: 10,
      ...
      icono: "📚",
      descripcion:
        "Proporcionar ayuda fácil de buscar, enfocada en tareas del usuario.",
      ruta: "/heuristica/10",
    },
  ]);
}
...
export class EstadoSistemaBuenoComponent {
  ...
  progress = signal(0);
  currentStatus = signal<"idle" | "preparing" | "uploading" | "completed">(
    "idle"
  );
        ...
        >
          ...
          <div>
            ...
            <div class="text-sm text-gray-600">
              Ver todos mis archivos y carpetas
            </div>
          </div>
        </button>
    ...
    >
      ...
      <form (ngSubmit)="onSubmit()">
        ...
        >
          ...
          Procesando... } @else if (registroExitoso()) {
          <span class="mr-2">✅</span>
...
export class RegistroBuenoComponent {
  ...
  validarNombre() {
    ...
    this.validaciones.update((v) => ({
      ...v,
      nombre: valido ? "valid" : "invalid",
    }));
  }
  ...
  validarPassword() {
    ...
    this.validaciones.update((v) => ({
      ...v,
      password: valido ? "valid" : "invalid",
    }));
  }

  calcularProgreso(): number {
    const validCount = Object.values(this.validaciones()).filter(
      (v) => v === "valid"
    ).length;
  ...
  template: `
    <div class="p-6 max-w-2xl mx-auto bg-white rounded shadow">
      ...
      <div class="space-y-4">
        ...
        <button
          class="border-2 border-blue-500 text-blue-500 px-4 py-3 rounded-none text-sm"
        >
        ...
        <button
          class="bg-yellow-300 text-black px-3 py-4 rounded-sm normal-case"
        >
          Guardar cambios
        </button>
      </div>
  ...
  template: `
    <div class="p-6 max-w-2xl mx-auto bg-white rounded-xl shadow-lg border">
      ...
      <div class="space-y-3">
        ...
        <button
          class="flex items-center w-full px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors"
        >
          <span class="mr-3">💾</span>
          Guardar Perfil
        </button>
      ...
      <div class="mt-8 grid grid-cols-2 gap-4">
        <h3 class="col-span-2 text-lg font-medium mb-3">
          Acciones de Eliminación
        </h3>

        <button
          class="flex flex-col items-center p-4 bg-red-50 hover:bg-red-100 border-2 border-red-200 rounded-lg transition-colors"
        >
        ...
        <button
          ...
          [ngClass]="{
            'bg-blue-600 hover:bg-blue-700 text-white':
              readyToTransfer() && !processing(),
            'bg-gray-300 text-gray-500 cursor-not-allowed':
              !readyToTransfer() || processing()
          }"
        >
          @if (processing()) { Procesando... } @else { 🔒 Confirmar
          Transferencia }
        </button>
      </form>
    </div>
...
export class PrevencionBuenoComponent {
  ...
  readyToTransfer(): boolean {
    return (
      this.accountValid() === true && this.amount > 0 && this.amount <= 10000
    );
  }
...
### Página inicial con Tailwind configurado y funcionando.

![Inicio](assets/06-heuristicas/01-inicio.png)

### Una captura por cada pagina de heuristica

#### 01. Visibilidad del Estado del Sistema

![01](assets/06-heuristicas/h-01.1.png)
![01](assets/06-heuristicas/h-01.2.png)

#### 02. Visibilidad del Estado del Sistema

![02](assets/06-heuristicas/h-02.1.png)
![02](assets/06-heuristicas/h-02.2.png)

#### 03. Visibilidad del Estado del Sistema

![03](assets/06-heuristicas/h-03.1.png)
![03](assets/06-heuristicas/h-03.2.png)

#### 04. Visibilidad del Estado del Sistema

![04](assets/06-heuristicas/h-04.png)

#### 05. Visibilidad del Estado del Sistema

![05](assets/06-heuristicas/h-05.1.png)
![05](assets/06-heuristicas/h-05.2.png)

#### 06. Visibilidad del Estado del Sistema

![06](assets/06-heuristicas/h-06.1.png)
![06](assets/06-heuristicas/h-06.2.png)

#### 07. Visibilidad del Estado del Sistema

![07](assets/06-heuristicas/h-07.1.png)
![07](assets/06-heuristicas/h-07.2.png)

#### 08. Visibilidad del Estado del Sistema

![08](assets/06-heuristicas/h-08.1.png)
![08](assets/06-heuristicas/h-08.2.png)

#### 09. Visibilidad del Estado del Sistema

![09](assets/06-heuristicas/h-09.1.png)
![09](assets/06-heuristicas/h-09.2.png)

#### 10. Visibilidad del Estado del Sistema

![10](assets/06-heuristicas/h-10.1.png)
![10](assets/06-heuristicas/h-10.2.png)

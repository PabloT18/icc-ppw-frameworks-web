...
```html
<div
  class="flex items-center justify-between p-4 mb-3 text-lg font-semibold bg-gray-100 border rounded-lg hover:bg-gray-200 md:text-xl"
></div>
```
...
```html
<section>
  <h1>TailwindCSS en acción</h1>

  <p>
    Este ejemplo demuestra cómo aplicar márgenes, colores, tamaños de texto y
    espaciado con utilidades de Tailwind.
  </p>
  ...
  <div>
    <div>
      ...
      <h3>Colores</h3>
      <p>
        Aplica paletas personalizadas mediante clases como
    ...
    <div>
      ...
      <h3>Layout</h3>
      <p>
        Crea estructuras flexibles con <code>flex</code> y <code>grid</code>.
      </p>
    </div>
  </div>
...
```html
<div
  class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-4xl"
></div>
```
...
<div class="mt-10">
  <button
    class="px-5 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400"
  >
    Botón interactivo
  </button>
</div>
...
1. Enlace a pagina desplegada
   (<https://nnyez.github.io/icc-u3-03-ui-componentes-estilos/>)

2. Captura de pagina con estilos aplicados

![Pagina](./assets/07-styles/01-page.png)

3. Captura de estilos-page.html

![html](./assets/07-styles/01-html.png)

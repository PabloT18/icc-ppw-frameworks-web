...
1. Página inicial con Tailwind configurado y funcionando. PASO 1
      ...
      ![Página inicial con tailwind y funcionando](./assets/interfazcentrada.png)
      **Descripción de la Imagen:** Esta captura muestra la interfaz centrada de usuario en un diseño sencillo.

2. Interfaz limpia, centrada en el usuario y con retroalimentación visual. PASO

      
      ![Página inicial con tailwind y funcionando](./assets/interfazcentradapaso.png)
      **Descripción de la Imagen:** Esta captura muestra el codigo a agregar en el html.

3. Codigo con ejemplos aplicados. PASO 3 y 4

      ![Página inicial con tailwind y funcionando](./assets/interfazcentradaFinal.png)
       **Descripción de la Imagen:** Esta captura muestra el resultado esperado final.

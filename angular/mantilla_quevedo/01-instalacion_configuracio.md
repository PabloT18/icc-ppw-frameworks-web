...
En esta captura se muestra el proceso de instalación de Angular CLI versión 20.3.6 mediante el gestor de paquetes pnpm (Node Package Manager). Los pasos realizados fueron:
...
Se crea un nuevo proyecto Angular llamado `my-app` utilizando el comando `ng new my-app`. y lo levantamos con `ng serve -o`

...
https://leofv87.github.io/03-ui-componentes-estilos/
...
![Cuadro Rojo](capturas/estilos/cuadro-rojo.png)


![Cuadro Verde](capturas/estilos/cuadro-verde.png)
...
![Barra roja](capturas/estilos/barra-roja.png)

Amarilla

![Barra amarilla](capturas/estilos/barra-verde.png)

Verde

![Barra verde](capturas/estilos/barra-verde.png)


Pagina final funcionando

![Pagina Funcionando](capturas/estilos/pagina-funcionando.png)


3. Captura de estilos-page (html y ts)

![Captura Estilos html](capturas/estilos/estilos-page-html.png)

![Captura Estilos ts](capturas/estilos/estilos-page-ts.png)


4. Captura de SignalProgress (html y ts)

![Captura Signal progress html](capturas/estilos/signal-progress-html.png)

![Captura Signal progress ts](capturas/estilos/signal-progress-ts.png)

5. Captura de SignalBox (html y ts)

![Captura signal Box html](capturas/estilos/signal-box-html.png)

![Captura signal Box ts](capturas/estilos/signal-box-ts.png)

...
![alt text](/angular/lazo_prieto/assets/lazo/instalacion.png)
...
- **Comando ejecutado:** `pnpm install -g @angular/cli@20.3.9`
  - El flag `-g` indica una instalación global, permitiendo usar Angular CLI desde cualquier ubicación del sistema.
  - Se especifica la versión exacta `@20.3.9` para garantizar compatibilidad y reproducibilidad del entorno.
...
![alt text](/angular/lazo_prieto/assets/lazo/instalado.png)
...
![Creación del Proyecto](/angular/lazo_prieto/assets/lazo/creando_proyecto.png)
![Comando ng-serve](/angular/lazo_prieto/assets/lazo/levantando.png)

### 4. Proyecto corriendo en el navegador:

![Proyecto corriendo en el navegador](/angular/lazo_prieto/assets/lazo/navegador.png)

###  5. Explicación de la estructura del proyecto:

![Estructura](/angular/lazo_prieto/assets/lazo/estructura.png)

...
![Captura de app.routes](/angular/lazo_prieto/assets/lazo/app_routes.png)
2. Captura de `perfilPage.ts`
![Captura de perfilPage ts](/angular/lazo_prieto/assets/lazo/perfilts.png)
3. Captura de `perfilPage.html`
![Captura de perfilPage html](/angular/lazo_prieto/assets/lazo/perfilhtml.png)
4. Captura de la pagina desplegada
![Página Desplegada](/angular/lazo_prieto/assets/lazo/02_navegador.png)

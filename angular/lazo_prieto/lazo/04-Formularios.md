...
**Adrian Lazo Cabrera**
📧 [blazocp@est.ups.edu.ec](mailto:blazoc@est.ups.edu.ec)
...
1. Tres capturas por cada pagina con los formularios  
  ...
  * Pagina formulario vacio
  ![Formularios básicos vacío](/angular/lazo_prieto/assets/lazo/04_vaciobasico.png)
  * Pagina formulario mostrar todos los errores
  ![Formularios básico errores](/angular/lazo_prieto/assets/lazo/04_basicoerrores.png)
  * Página formulario enviado correctamente y muestra en listado
  ![Formularios básico correcto](/angular/lazo_prieto/assets/lazo/04_basicocorrecto.png)
  **Formularios Dinámicos**
  * Pagina formulario vacio
  ![Formularios dinámicos vacío](/angular/lazo_prieto/assets/lazo/04_dinamicovacio.png)
  * Pagina formulario mostrar todos los errores
  ![Formularios dinámicos errores](/angular/lazo_prieto/assets/lazo/04_dinamicoerrores.png)
  * Página formulario enviado correctamente y muestra en listado
  ![Formularios dinámico correcto](/angular/lazo_prieto/assets/lazo/04_dinamicocorrecto.png)
  **Formularios Switches**
  * Pagina formulario vacio
  ![Formularios switches vacío](/angular/lazo_prieto/assets/lazo/04_switchesvacio.png)
  * Pagina formulario mostrar todos los errores
  ![Formularios switches errores](/angular/lazo_prieto/assets/lazo/04_switcheserrores.png)
  * Página formulario enviado correctamente y muestra en listado
  ![Formularios switches correcto](/angular/lazo_prieto/assets/lazo/04_switchescorrecto.png)

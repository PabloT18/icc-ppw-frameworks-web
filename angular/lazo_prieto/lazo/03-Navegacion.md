...
![Conf de Rutas](/angular/lazo_prieto/assets/lazo/03_rutas.png)

### 2. Navegación con RouterLink
![RouterLink](/angular/lazo_prieto/assets/lazo/03_nav.png)
...
- **Repositorio GitHub**: 
[Enlace a Repositorio](https://github.com/scomygod/icc-ppw-practica01.git)
- **GitHub Pages**: 
[Enlace a la aplicación desplegada](https://scomygod.github.io/icc-ppw-practica01/)

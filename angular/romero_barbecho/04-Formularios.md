...
## formularios basicos
1. todo error.
![captura de formulario basico con todos los errores.](assets\basicoerror.png)

2. error al no cumplir con los campos.

![error al no cumplir con los campos solicitados](assets\camposinvalidosbasic.png))

3. todo funcionando correctamente.

![formulario correcto listo para enviar](assets\correctobasic.png)

## formulario Dinamico

1. todo error.
![captura de formulario basico con todos los errores.](assets\errordimanic.png)

2. error al no cumplir con los campos.

![error al no cumplir con los campos solicitados](assets\faltadinamic.png)

3. todo funcionando correctamente.

![formulario correcto listo para enviar](assets\biendinamic.png)


# formulario More

1. todo error.
![captura de formulario basico con todos los errores.](\assets\fallomore.png)

2. error al no cumplir con los campos.

![error al no cumplir con los campos solicitados](assets\morecampos.png)

3. todo funcionando correctamente.

![formulario correcto listo para enviar](assets\morebien.png)
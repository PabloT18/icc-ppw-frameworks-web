...
https://juanfernando518.github.io/03-ui-componentes-estilos/

2. Captura de pagina con estilos aplicados 

![alt text](assets/Imagen23.jpg)

![alt text](assets/Imagen24.jpg)

![alt text](assets/Imagen25.jpg)
...
<section class="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-8">
  ...
  <p class="text-gray-600 mb-6 max-w-xl text-center">
    Este ejemplo demuestra cómo aplicar márgenes, colores, tamaños de texto y espaciado
    con utilidades de Tailwind.
  </p>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
    ...
    <div class="bg-white shadow rounded-lg p-4 flex flex-col items-center">
      <i class="fas fa-palette text-4xl text-blue-500 mb-2"></i>
      <h3 class="text-lg font-bold mb-2">Colores</h3>
      <p class="text-gray-600 text-center">
        Aplica paletas personalizadas mediante clases como <code>bg-blue-500</code>.
      </p>
    </div>

    <!-- Card 2 -->
    <div class="bg-white shadow rounded-lg p-4 flex flex-col items-center">
      <i class="fas fa-arrows-alt text-4xl text-green-500 mb-2"></i>
      <h3 class="text-lg font-bold mb-2">Espaciado</h3>
      <p class="text-gray-600 text-center">
    ...
    <div class="bg-white shadow rounded-lg p-4 flex flex-col items-center">
      ...
      <h3 class="text-lg font-bold mb-2">Layout</h3>
      <p class="text-gray-600 text-center">
  ...
  <app-signal-box></app-signal-box>
  <app-signal-progress></app-signal-progress>
</section>
```

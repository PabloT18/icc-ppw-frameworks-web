...
## Práctica A2: Panel de Administración
...
function ejecutarEliminar(): void {
  if (idEliminar.value !== null) {
    ...
    alert(`Producto ${idEliminar.value} eliminado (simulado)`)
  }
...
git commit -m "feat: CRUD de productos en panel admin con tabla y modales"
```

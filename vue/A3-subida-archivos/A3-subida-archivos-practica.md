...
## Práctica A3: Subida de Archivos
...
Se extiende el proyecto `ppw-vue-app`. El componente de subida se integra en el panel de administración (A2) para permitir cambiar la imagen de un producto.
...
<template>
  <div class="uploader">
    <h3 class="titulo">Subir imagen del producto</h3>
    ...
    <!-- Mensaje de éxito -->
    <p v-if="exitoso" class="mensaje-exito">✅ Imagen subida correctamente</p>
    ...
    <div class="acciones" v-if="previewUrl">
      ...
      >
        {{ subiendo ? 'Subiendo...' : exitoso ? '¡Listo!' : 'Subir imagen' }}
      </button>
    </div>
  </div>
</template>
...
## Paso 3: Integrar el uploader en el panel admin
  ...
  <div class="demo-wrapper">
    ...
    <div class="info-tecnica">
      ...
      <ul>
        ...
        <li>Al hacer clic en "Subir", se simula el envío con progreso</li>
...
- [ ] El botón "Subir" activa la barra de progreso que va de 0 a 100%
